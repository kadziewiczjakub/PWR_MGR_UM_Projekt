...
def exp1():
	...
	windows = [3, 6, 10, 20, 30, 60, 120] # TODO change if needed
	...
	CLASSIFIERS = [
		RandomForestClassifier(n_estimators=100, n_jobs=-1, random_state=38),
		RandomForestClassifier(n_estimators=500, n_jobs=-1, random_state=38),
	...
	SPLITTERS = [
		RepeatedKFold(n_splits=5, n_repeats=2, random_state=38),
		RepeatedStratifiedKFold(n_splits=5, n_repeats=2, random_state=38),
